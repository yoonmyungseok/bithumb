...
def evaluate_swing_trend_exit(
    ...
    - 거래소별 4시간봉(240분봉) 마감 주기 차이:
      * 빗썸: 00:00, 04:00, 08:00, 12:00, 16:00, 20:00 KST
      * 업비트: 01:00, 05:00, 09:00, 13:00, 17:00, 21:00 KST (1시간 위상차)
      * 확정봉 기준(`select_completed_candles`)으로만 연산하므로 위상차가 있어도 안정적으로 보호됨
